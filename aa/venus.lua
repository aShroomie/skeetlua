...
local menu = {
    ...
    ["anti-aim"] = {
        ...
        dt_teleport=ui_new_hotkey(tab, container, "Lag exploit (have ragebot on key)"),
        builder = {},
    },
...
functions["menu"].visibility = function()
    if ui.is_menu_open() then
        ...
        ui_set_visible(menu["anti-aim"].dt_teleport,ui_menu.selected_tab == ui_menu.easier_tab.aa2)
